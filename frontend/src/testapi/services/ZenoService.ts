...
export class ZenoService {
     ...
     * Get metrics for set of slices
     *
     * Args:
     * reqs (List[MetricKey]): Metric key describing a slice/model combination.
     *
     * Returns:
